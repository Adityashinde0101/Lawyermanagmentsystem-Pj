...
function lawyermanagement() {
    ...
    $query = "SELECT case_id, case_name, case_number, case_type FROM cases WHERE lawyer_id = '".$_SESSION['lawyer_id']."'";
            ...
            <?php
                ...
                if ($records) {
                    foreach ($records as $record) {
						...
						echo "<td><a href='viewcase.php?id=" . $record['case_id'] . "' class='btn btn-primary'>View</a></td>";
