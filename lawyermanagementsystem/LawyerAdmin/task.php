...
function lawyermanagement()
{
	...
	$query = "SELECT case_name, case_number, case_type FROM cases where lawyer_id = '".$_SESSION['lawyer_id']."'";
			...
			<div class="existing-records">
				...
				<table>
					...
					<tbody>
						...
						// Perform SQL query to fetch case records
						$query = "SELECT task_subject, end_date, status1, priority, task_description FROM task where lawyer_id = '".$_SESSION['lawyer_id']."'";
