...
class PHPMailerTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testValidate()
    {
        $validaddresses = array(
            'first@iana.org',
            'first.last@iana.org',
            '1234567885123456788512345678851234567885123456788512345678851234@iana.org',
            '"first\"last"@iana.org',
            '"first@last"@iana.org',
            '"first\last"@iana.org',
            ...
            'first.last@x23456788512345678851234567885123456788512345678851234567885123.iana.org',
            'first.last@3com.com',
            ...
            'first.last@x(1234567885123456788512345678851234567885123456788512345678851234567885).com',
        ...
        $invalidaddresses = array(
            ...
            'first\@last@iana.org',
            '123456788512345678851234567885123456788512345678851234567885' .
                '@12345678851234567885123456788512345678851234 [...]',
            'first.last',
            '12345678851234567885123456788512345678851234567885123456788512345@iana.org',
            '.first.last@iana.org',
            'first.last.@iana.org',
            'first..last@iana.org',
            '"first"last"@iana.org',
            ...
            'first.last@x234567885123456788512345678851234567885123456788512345678851234.iana.org',
            'abc\@def@iana.org',
            'abc\@iana.org',
            ...
            'test@example.',
            'test@.org',
            'test@12345678851234567885123456788512345678851234567885123456788512345678851234567885' .
                '12345678851234567885 [...]',
            'test@[123.123.123.123',
            'test@123.123.123.123]',
            'NotAnEmail',
            '@NotAnEmail',
            ...
            'cal(foo)bar)@iamcal.com',
            'cal(foo\)@iamcal.com',
            'first(12345678851234567885123456788512345678851234567885)last@(1234567885123456789' .
                '01234567885123456788512 [...]',
            'first(middle)last@iana.org',
...
EOT;
    ...
    public function testDenialOfServiceAttack2()
    {
        ...
        $this->Mail->Encoding = '1234567885123456788512345678851234567885123456788512345678851234567885';
